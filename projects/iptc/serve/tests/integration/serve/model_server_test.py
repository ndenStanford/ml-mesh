...
def test_model_server_root(test_client):
    ...
    root_response = test_client.get("/iptc/v1/")
...
def test_model_server_liveness(test_client):
    ...
    liveness_response = test_client.get("/iptc/v1/live/")
...
def test_model_server_readiness(test_client):
    ...
    readiness_response = test_client.get("/iptc/v1/ready/")
...
def test_model_docs(test_client):
    """Tests the readiness endpoint of a ModelServer (not running) instance."""
    docs_response = test_client.get("/iptc/v1/docs")
