...
def test_register(
    mock_feature_view, mock_entity, mock_redshift_source_custom, mock_feature_store_handle
):
    ...
    assert mock_feature_store_handle.register.call_args_list[1][0][0] == [mock_feature_view]
