...
def test_model_server_root():
    ...
    root_response = requests.get("http://serve:8000/v1/")
...
def test_model_server_liveness():
    ...
    liveness_response = requests.get("http://serve:8000/v1/live")
...
def test_model_server_readiness():
    ...
    readiness_response = requests.get("http://serve:8000/v1/ready")
...
def test_model_server_bio():
    """Tests the readiness endpoint of a ModelServer (not running) instance."""
    readiness_response = requests.get("http://serve:8000/v1/model/ner/bio")
...
def test_model_server_prediction(payload, expected_response):
    ...
    response = requests.post(
        "http://serve:8000/v1/model/ner/predict",
        json=payload,
    )
