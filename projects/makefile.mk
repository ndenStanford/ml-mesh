...
projects.start/%: # Run main task of component in container
	@MODEL_ID=$(MODEL_ID) docker compose -f projects/$(notdir $@)/docker-compose.$(ENVIRONMENT).yaml --profile $(COMPONENT) up $(COMPONENT) --exit-code-from $(COMPONENT) --force-recreate --attach-dependencies
