...
def test_served_model_params_env_prefix():
    """Tests the inherited environment variable prefix."""
...
def test_served_model_params_set_fields_via_env_vars(
    ...
    """Tests the correct behaviour of the inherited environment variable prefix.

    Initializes an instance after setting the corresponding environment variables
    in the local test scope.
    """
