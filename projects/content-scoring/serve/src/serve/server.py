...
from src.serve.model import (
    ServedContentScoringModel,  # type: ignore[attr-defined]
)
...
def get_model_server(artifacts: ServedModelArtifacts) -> ModelServer:
    ...
    """
    # initialize model
    cs_served_model = ServedContentScoringModel(served_model_artifacts=artifacts)
