...
CANDIDATE_DICT_FOURTH = {'dance': {'0': {'name': 'ballet',
 ...
 'monument and heritage site': {'0': {'name': 'restoration',
 ...
 'social media': {'0': {'name': 'influencers',
 ...
 'natural disaster': {'0': {'name': 'drought',
  ...
  '4': {'name': 'meteorological disaster',
 ...
 'international trade': {'0': {'name': 'balance of trade',
 ...
 'monetary policy': {'0': {'name': 'interest rates',
 ...
 'commodities market': {'0': {'name': 'energy market',
 ...
 'business service': {'0': {'name': 'consultancy',
  ...
  '5': {'name': 'shipping and postal service',
  ...
  '6': {'name': 'trade show or expo',
   'description': 'Market place to display and trade goods or services'}},
 'chemicals': {},
 'computing and information technology': {'0': {'name': 'computer and telecommunications hardware',
  ...
  '2': {'name': 'semiconductor and electronic component',
 ...
 'consumer goods': {'0': {'name': 'beverage and grocery',
  ...
  '6': {'name': 'pet product and service',
   'description': 'Hygiene products, care and nutrition for pets'},
  '7': {'name': 'tobacco and nicotine',
 ...
 'energy and resource': {'0': {'name': 'biofuel',
  ...
  '4': {'name': 'renewable energy',
   'description': 'Energy derived from sustainable sources'}},
 'financial and business service': {},
 'financial service': {'0': {'name': 'accountancy and auditing',
  ...
  '3': {'name': 'financial advisory service',
 ...
 'manufacturing and engineering': {'0': {'name': 'aerospace',
 ...
 'mental health and disorder': {'0': {'name': 'anxiety and stress',
 ...
 'medical specialisation': {'0': {'name': 'dentistry',
 ...
 'employment training': {},
 'wages and benefits': {'0': {'name': 'profit sharing',
 ...
 'labour dispute': {'0': {'name': 'labour strike',
 ...
 'game': {'0': {'name': 'board game',
   'description': 'A game played on a board'},
  '1': {'name': 'card game',
   'description': 'A game played with a pack of cards'},
  '2': {'name': "children's game",
  ...
  '4': {'name': 'outdoor game',
   'description': 'A game played in an open space'},
  '5': {'name': 'puzzle',
 ...
 'hobby': {'0': {'name': 'automobile enthusiasm',
   'description': 'Interest in new and classic cars'},
  '1': {'name': 'bicycle enthusiasm',
 ...
 'outdoor recreational activities': {'0': {'name': 'fishing',
  ...
  '3': {'name': 'recreational hiking and climbing',
 ...
 'political parties and movements': {'0': {'name': 'political leadership',
   'description': 'The leaders within a political party'}},
 'political system': {'0': {'name': 'democracy',
 ...
 'Christianity': {'0': {'name': 'Catholicism',
 ...
 'archery': {'0': {'name': 'crossbow shooting',
 ...
 'athletics': {'0': {'name': 'cross-country run',
  ...
  '17': {'name': 'steeplechase (athletics)',
 ...
 'baseball': {'0': {'name': 'rubberball baseball',
 ...
 'boxing': {},
 'canoeing': {},
 'competitive dancing': {'0': {'name': 'breaking (breakdance)',
 ...
 'gymnastics': {'0': {'name': 'artistic gymnastics',
 ...
 'motor car racing': {},
 'motorcycling': {},
 'mountain climbing': {'0': {'name': 'ice climbing',
   'description': 'Climbing of ice features such as icefalls and frozen cliffs'},
  '1': {'name': 'mountaineering',
   'description': 'Competitive alpine climbing'}},
 'orienteering': {'0': {'name': 'ski orienteering',
 ...
 'rodeo': {'0': {'name': 'bareback bronc', 'description': 'Rodeo discipline'},
 ...
 'sport shooting': {},
 'swimming': {'0': {'name': 'marathon swimming',
   'description': 'A long distance open water swimming'}},
 'volleyball': {'0': {'name': 'beach volleyball',
