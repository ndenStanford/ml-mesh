...
from onclusiveml.ts.typing import ArrayLike, Figsize
...
class SeasonalityHandler:
    ...
    Attributes:
        ...
        Other possible values: 'hourly', 'weekly', 'biweekly', 'monthly', 'yearly'
        or integer which represent amoutn of seconds.

    >>> # Example usage:
    >>> from onclusiveml.ts.simulator import Simulator
