...
class DcumentDBModel(BaseDataModel[Dyntastic]):
    ...
    def table_name(self) -> str:
        ...
        """
        return self.model._AbstractRepository__collection_name
    ...
    def get_one(self, id: str) -> Dyntastic:
        ...
        """
        try:
            item = self.model.find_one_by_id(id)
            if item is None:
    ...
    def update(self, id: str, item: Dict[str, Any]) -> Dyntastic:
        ...
        """
        try:
            existing_item = self.model.find_one_by_id(id)
