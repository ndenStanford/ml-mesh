...
class MockTokenizer(object):
    ...
    def __call__(self, text: str, padding: str = None, **kwargs):
        ...
        if padding == 'max_length':
            tokens = tokens + [0,] * (self.model_max_length - len(tokens))
...
def custom_tokenization_settings():
    ...
    return {'setting_1': 'A', 'setting_2': 10, 'setting_3': True, 'padding':'some value', 'truncation': False, 'add_special_tokens': False, 'max_length': 20}
