...
def test_word_tokenize_pa():
    """Test word tokenizer Punjabi."""
    text = "ਐਲੋਨ ਮਸਕ ਹੁਣ ਤੱਕ ਦਾ ਦੂਜਾ ਵਿਅਕਤੀ ਸੀ ਜਿਸ ਨੇ $200 ਬਿਲੀਅਨ ਤੋਂ ਵੱਧ ਦੀ ਨਿੱਜੀ ਜਾਇਦਾਦ ਇਕੱਠੀ ਕੀਤੀ, \
        ਜਨਵਰੀ 2021 ਵਿੱਚ, ਜੈੱਫ ਬੇਜੋਸ ਦੇ ਮਹੀਨਿਆਂ ਬਾਅਦ, ਉਸ ਸੀਮਾ ਦੀ ਉਲੰਘਣਾ ਕੀਤੀ।"
    tokenizer = WordTokenizer()
