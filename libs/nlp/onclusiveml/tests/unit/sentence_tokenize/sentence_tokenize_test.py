...
def test_tokenize_pa():
    ...
    assert res["sentences"] == [
        ...
        " ਉਹ ਏਰੋਲ ਮਸਕ, ਇੱਕ ਅਮੀਰ ਦੱਖਣੀ ਅਫ਼ਰੀਕੀ ਇੰਜੀਨੀਅਰ ਅਤੇ ਅਫ਼ਰੀਕਨੇਰ ਅਤੇ ਐਂਗਲੋ-ਦੱਖਣੀ \
        ਅਫ਼ਰੀਕੀ ਮੂਲ ਦੇ ਰੀਅਲ ਅਸਟੇਟ ਡਿਵੈਲਪਰ ਦਾ ਪੁੱਤਰ ਹੈ, \
        ਜਿਸਦਾ ਜ਼ੈਂਬੀਆ ਵਿੱਚ ਇੱਕ ਪੰਨੇ ਦੀ ਖਾਨ ਵਿੱਚ ਸ਼ੇਅਰ ਸੀ, \
        ਅਤੇ ਇੱਕ ਪੋਸ਼ਣ ਵਿਗਿਆਨੀ ਅਤੇ ਕੈਨੇਡੀਅਨ ਮਾਏ ਹੈਲਡੇਮੈਨ",
