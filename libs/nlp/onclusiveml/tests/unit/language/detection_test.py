...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            [LanguageIso.EN],
            LanguageFilterException,
            "The language 'LanguageIso.FR' that was looked up from 'fr' or inferred from the content, is currently not supported. Supported languages are: ['en'].",  # noqa: E501
        ),
        (
            "Hola, cómo estás",
            None,
            [LanguageIso.EN],
            LanguageFilterException,
            "The language 'LanguageIso.ES' that was looked up from 'None' or inferred from the content, is currently not supported. Supported languages are: ['en'].",  # noqa: E501
        ),
        (
            "Test string",
            "abc",
            [LanguageIso.EN],
            LanguageDetectionException,
            "The language reference 'abc' could not be mapped, or the language could not be inferred from the content. Supported references are: ['en'].",  # noqa: E501
        ),
    ],
)
