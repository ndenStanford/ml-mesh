...
class GeneratedNotFound(BasePromptException):
    ...
    message_format = "Generated with id '{generated_id}' was not found in database."


class GeneratedExisting(BasePromptException):
    """Generated already exists."""

    message_format = "Generated with id '{generated_id}' already exists in database."


class GeneratedInvalidId(BasePromptException):
    """Generated Not Found."""

    message_format = "Generated id: '{generated_id}' is invalid"
