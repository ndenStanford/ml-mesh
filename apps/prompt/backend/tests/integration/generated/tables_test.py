...
def test_save(data, app):
    """Test save."""
    generated = Generated(id=data['id'], generation=data['generation'], method=data['generation'], args=data['args'], kwargs=data['kwargs'], timestamp=data['timestamp'])
    generated.save()
...
@pytest.mark.parametrize(
    "id",
    [
       "e2478dc2-08ec-42bc-928a-c9e59c3fafe"
    ]
)
