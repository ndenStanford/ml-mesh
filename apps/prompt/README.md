...
`690763002009.dkr.ecr.us-east-2.amazonaws.com/prompt-backend:$IMAGE_TAG`, run the following command:
...
`690763002009.dkr.ecr.us-east-2.amazonaws.com/prompt-frontend:$IMAGE_TAG`, run the following command:
