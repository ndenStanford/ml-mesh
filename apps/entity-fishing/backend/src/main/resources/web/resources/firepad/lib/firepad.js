...
firepad.Firepad = (function (global) {
  ...
  function Firepad(ref, place, options) {
    ...
    if (!CodeMirror && !ace) {
      throw new Error(
        "Couldn't find CodeMirror or ACE.  Did you forget to include codemirror.js or ace.js?"
      );
    }
    ...
    var editorWrapper = this.codeMirror_
  ...
  Firepad.prototype.getText = function () {
    ...
    else return this.ace_.getSession().getDocument().getValue();
  };
