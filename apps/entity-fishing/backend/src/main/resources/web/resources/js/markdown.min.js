!(function (a) {
  ...
  (k.forEach = Array.prototype.forEach
    ? function (a, b, c) {
    ...
    (k.extract_attr = function (a) {
      return l(a) && a.length > 1 && "object" == typeof a[1] && !l(a[1])
        ? a[1]
        : void 0;
    });
  var m = function (a) {
  ...
  (m.parse = function (a, b) {
    ...
    (m.prototype.split_blocks = function (a) {
      ...
      for (
        null !== (b = /^(\s*\n)/.exec(a)) &&
        ((f += d(b[0])), (c.lastIndex = b[0].length));
        null !== (b = c.exec(a));
      ...
      block: {
        atxHeader: function (a, b) {
          ...
          return (
            ...
            c[0].length < a.length &&
              b.unshift(n(a.substr(c[0].length), a.trailing, a.lineNumber + 2)),
            [d]
          );
        },
            ...
            for (var l, m, n = [], o = j(k), p = !1, r = [n[0].list]; ; ) {
              for (
                ...
                if (((k = w.match(x)), void 0 !== k[1])) {
                  t.length &&
                    (c(l, p, this.processInline(t), u), (p = !1), (t = "")),
                    (k[1] = b(k[1]));
                  ...
                  if (y > n.length)
                    ...
                    z ||
                      (y++,
                      y <= n.length
                        ? (n.splice(y, n.length - y), (o = n[y - 1].list))
                        : ((o = j(k)), l.push(o))),
                      (l = ["listitem"]),
                      o.push(l);
                  }
              ...
              var A = d(n.length, i);
              A.length > 0 &&
                (q(n, e, this), l.push.apply(l, this.toTree(A, [])));
        ...
        blockquote: function (a, b) {
          ...
          var i = a.replace(/^> ?/gm, ""),
            ...
            k = o(j);
          return (
            k && k.references && (delete k.references, r(k) && j.splice(1, 1)),
            c.push(j),
            c
          );
        },
      ...
      inline: {
        ...
        "![": function (a) {
          ...
          if (b) {
            ...
            return (
              void 0 !== b[4] && (c.title = b[4]), [b[0].length, ["img", c]]
            );
          }
          return (
            (b = a.match(/^!\[(.*?)\][ \t]*\[(.*?)\]/)),
  ...
  (u.processMetaHash = function (a) {
    ...
    (u.block.table = function w(a) {
      ...
      for (
        ...
        w[1][1].push(
          ["th", g[b] || {}].concat(this.processInline(c[1][b].trim()))
        );
      return (
        q(
          c[3].replace(/\|\s*$/gm, "").split("\n"),
          function (a) {
            var c = ["tr"];
            for (a = d(a, "|"), b = 0; b < a.length; b++)
              c.push(
                ["td", g[b] || {}].concat(this.processInline(a[b].trim()))
              );
            w[2].push(c);
          },
          this
