...
firepad.RichTextCodeMirror = (function () {
   ...
   * @private
   */
  RichTextCodeMirror.prototype.markLineSentinelCharactersForChanges_ =
    function (changes) {
  ...
  RichTextCodeMirror.prototype.markLineSentinelCharactersForChangedLines_ =
